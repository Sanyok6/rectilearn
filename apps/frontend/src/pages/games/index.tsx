...
const Games: NextPage = () => {
    ...
    useEffect(() => {
        ...
        switch (gameSession.game) {
            case "lavaGame":
                setGameObj(() => <LavaGame studySet={gameSession.studySet}></LavaGame>)
                break;
            case "fishingGame":
                setGameObj(() => <FishingGame studySet={gameSession.studySet}></FishingGame>)
                break;
            case "bushGame":
                setGameObj(() => <BushGame studySet={gameSession.studySet}></BushGame>)
                break;
            case "foodFight":
                setGameObj(() => <FoodFight studySet={gameSession.studySet}></FoodFight>)
                break;
            case "practice":
                setGameObj(() => <Questions studySet={gameSession.studySet}></Questions>)
                break;
            default:
